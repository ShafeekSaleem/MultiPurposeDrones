...
f1 = client.moveToPositionAsync(-5, 5, -10, 10, vehicle_name="Drone1")
f2 = client.moveToPositionAsync(5, -5, -10, 10, vehicle_name="Drone2")
f3 = client.moveToPositionAsync(-5,- 5, -10, 10, vehicle_name="Drone3")
f4 = client.moveToPositionAsync(5, 5, -10, 5, vehicle_name="Drone4")
f1.join()
f2.join()
f3.join()
f4.join()
